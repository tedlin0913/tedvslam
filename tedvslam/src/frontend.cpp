...
namespace tedvslam
{
    ...
    int Frontend::EstimateCurrentPose()
    {
        ...
        // rclcpp::RCLCPP_INFO(rclcpp::get_logger("global_logger") this->get_logger(), "Outlier/Inlier in pose estimating: %d/%lu",
        // cnt_outlier, features.size() - cnt_outlier);

        current_frame_->SetPose(vertex_pose->estimate());

        // rclcpp::RCLCPP_INFO(rclcpp::get_logger("global_logger") this->get_logger(), "Current Pose = \n%s",
        // current_frame_->Pose().matrix().format(Eigen::IOFormat()).c_str());
